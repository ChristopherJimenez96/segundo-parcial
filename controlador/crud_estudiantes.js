...
crud_estudiante.leer = (req,res)=>{
    ...
    conectar.query('SELECT estudiantes.id_estudiante,estudinates.carnet,estudiantes.nombres,estudiantes.apellidos,estudiantes.direccion,estudiantes.telefono,estudiantes.genero,estudiantes.email, DATE_FORMAT(estudiantes.fecha_nacimiento,"%d-%m-%Y") as fecha_nacimiento FROM estudiantes;',(error,results)=>{
        if (error){
            throw error;
